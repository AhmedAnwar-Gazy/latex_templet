\begin{titlepage}
    ...
    \begin{center}
        % Title
        \textbf{\Large Developing a Social Media Platform Utilizing} \\[0.2cm]
        \textbf{\Large Advanced Recommendation Algorithms}
        ...
        \normalsize - Ahmed Anwar Hatem \\[0.1cm]
        \normalsize - Nader Mohammed Mohsen \\[0.1cm]
        \normalsize - Mohammed Mogeab Ahmed \\[0.1cm]
        \normalsize - Ali AbdulSalam Mohammed \\[0.1cm]
        \normalsize - Hani Ahmed Saleh
        
        \vspace{0.6cm}
        
        % Supervisor
        \textbf{\normalsize Supervisor} \\[0.3cm]
        \normalsize Dr. Ziad Al-Rabih
